...
def load_news_dataframe(news_path='corn_all_news_with_sentiment.csv', 
                        start_date=None, end_date=None, window_days=7):
    """
...
class CornPricePredictor:
    ...
    def predict_with_evidence(self, news_data, price_history, target_date, 
                             news_df_full=None, news_path='corn_all_news_with_sentiment.csv',
                             top_k=2):
        """
        근거 뉴스를 포함한 예측 수행
...
def predict_with_evidence(news_data, price_history, target_date,
                         news_df_full=None, news_path='corn_all_news_with_sentiment.csv',
                         model_dir='models', top_k=2):
    """
