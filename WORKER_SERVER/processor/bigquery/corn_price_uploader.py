...
def upload_corn_price_for_date(
    target_date,
    ema_period=20,
    symbol="ZM1!",
    exchange="CBOT",
    ...
    # Fetch enough bars to compute EMA for target_date
...
def _parse_args():
    parser = argparse.ArgumentParser(description="Upload daily corn price to BigQuery.")
    parser.add_argument("--date", required=True, help="YYYY-MM-DD")
    parser.add_argument("--ema-period", type=int, default=20)
    parser.add_argument("--symbol", default="ZM1!")
    parser.add_argument("--exchange", default="CBOT")
    parser.add_argument("--dataset-id", default="tilda")
    parser.add_argument("--table-id", default="corn_price")
    parser.add_argument(
        "--schema-path",
