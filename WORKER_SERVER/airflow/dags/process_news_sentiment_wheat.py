...
TARGET_TABLE = "wheat_all_news_with_sentiment"
COMMODITY = "wheat"
...
with DAG(
    'process_news_sentiment_wheat_v1',
    default_args=default_args,
    description='Wheat 뉴스 감성 분석 및 적재 (Incremental)',
    schedule_interval='35 * * * *', # 매시간 35분
    catchup=False,
    tags=['news', 'sentiment', 'wheat', 'finbert']
) as dag:
