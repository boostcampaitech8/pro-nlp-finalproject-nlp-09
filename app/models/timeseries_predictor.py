...
# TODO XGBoostInference 모듈 임포트로 코드 변경할 것
...
#         history_df = bq_client.get_prophet_features(target_date=target_date, lookback_days=3000)
